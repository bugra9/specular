...
let createDifferentialPackage = exports.createDifferentialPackage = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (archiveFile) {
        ...
        try {
            ...
            const blockMapFileData = yield serializeBlockMap(blockMap, archiveFile);
            ...
            const result = yield createFileInfo(blockMapFileData, archiveFile, (yield (0, (_fsExtraP || _load_fsExtraP()).stat)(archiveFile)).size);
...
let serializeBlockMap = (() => {
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (blockMap, file) {
        ...
        const blockMapFileData = yield gzip(blockMapDataString, { level: 9, chunkSize: 1024 * 1024 });
        if (process.env.DEBUG_BLOCKMAP) {
            const buffer = Buffer.from(blockMapDataString);
            yield (0, (_fsExtraP || _load_fsExtraP()).writeFile)(`${file}.blockMap.json`, buffer);
            console.log(`BlockMap size: ${buffer.length}, compressed: ${blockMapFileData.length}`);
        }
        return blockMapFileData;
    });

    return function serializeBlockMap(_x2, _x3) {
        return _ref2.apply(this, arguments);
    };
})();

let createFileInfo = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (blockMapData, file, fileSize) {
        return {
            path: file,
            size: fileSize,
    ...
    return function createFileInfo(_x4, _x5, _x6) {
        return _ref3.apply(this, arguments);
    };
})();

let createPackageFileInfo = exports.createPackageFileInfo = (() => {
    var _ref4 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (file, blockMapSize) {
        return {
            path: file,
...
let computeBlockMap = exports.computeBlockMap = (() => {
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (sevenZFile) {
...
let doComputeBlockMap = (() => {
    var _ref6 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (files, fd) {
        ...
        const blocks = yield (_bluebirdLst2 || _load_bluebirdLst2()).default.map(files, (() => {
            var _ref7 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (file) {
